...
| ADR-21 | Konuşma öncelikli runtime — ana ajan (`session` rolü), kabiliyet olarak orkestrasyon (ADR-02/08/09/15'i kısmen değiştirir) | Accepted | 2026-09-23 | [ADR-21](./ADR-21-conversation-first-runtime.md) | [policy-and-approval](../contracts/policy-and-approval.md), [runtime-seams](../contracts/runtime-seams.md), [cli-and-jsonl](../contracts/cli-and-jsonl.md) | HREQ-023…HREQ-040 |
