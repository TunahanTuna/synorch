...
- AC-a8 (F18) `read_file` ve `exec` modele en çok 16 KiB (baş + son; `ToolResult.text` üst sınırı) gösterir; tamamı blob'ta, metinde "truncated; use offset/limit" notu.
