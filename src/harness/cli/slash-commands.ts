...
export const CONVERSATION_COMMANDS: readonly SlashCommand[] = [
  ...
  { name: "/review", argsHint: "[focus]", description: "independent review of the uncommitted changes, else the last commit (fresh context, reviewer on another provider when logged in)", run: (host, argument) => host.review(argument) },
