...
/**
 * Tool-side copy of the policy module's scope matcher (modules may share only contracts, ADR-01).
 * Tools use it to filter multi-path reads (search results, git output) at action time; the
 * PolicyEngine remains the authority for the action itself.
 *
